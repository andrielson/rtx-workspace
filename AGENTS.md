...
- Whenever information about Bun is needed (APIs, CLI, runtime behavior, releases), research it through the `deepwiki` MCP against the `oven-sh/bun` GitHub repository.
